...
function createDefaultDeck(){
  ...
  addColorD('water', 'flooring', '#66bbdd', 50, [new Property(0, ['desert', 'grassland', 'snow'], 1), new Property(50, ['water'], 2), new Property(0, ['material', 'mountains', 'lake', 'woods', 'village', 'metal', 'gold', 'castle', 'castle2', 'castle3', 'fortification', 'fortification2', 'fortification3'], 0)])

  addColorD('mountains', 'element', '#a75f49', 5, [new Property(0, ['water'], 0), new Property(1, ['gold', 'metal', 'castle', 'castle2', 'castle3', 'fortification', 'fortification2', 'fortification3'], 0)], 3)
  addColorD('woods', 'element', '#bca26f', 7, [new Property(0, ['water', 'desert', 'village', 'metal', 'gold'], 0), new Property(1, ['castle', 'castle2', 'castle3', 'fortification', 'fortification2', 'fortification3'], 0)], 2)
  addColorD('lake', 'element', '#64e1e2', 5, [new Property(0, ['water', 'village', 'metal', 'gold', 'material', 'castle', 'castle2', 'castle3', 'fortification', 'fortification2', 'fortification3'], 0)], 2)
