    ...
    for (r = 0; r < rows; r++){
      for (c = 0; c < columns; c++){
        if (data[tiles[r*columns+c][arg3].chosen].color != "none"){
          ...
          ctx.beginPath()
          ctx.moveTo(c * dimension + tiles[r*columns+c][arg3].vpravo[0] * dimension, r * dimension + tiles[r*columns+c][arg3].vpravo[1] * dimension)
          ctx.lineTo(c * dimension + tiles[r*columns+c][arg3]["vpravo,dole"][0] * dimension, r * dimension + tiles[r*columns+c][arg3]["vpravo,dole"][1] * dimension)
          ctx.lineTo(c * dimension + tiles[r*columns+c][arg3].dole[0] * dimension, r * dimension + tiles[r*columns+c][arg3].dole[1] * dimension)
          ctx.lineTo(c * dimension + tiles[r*columns+c][arg3]["vlavo,dole"][0] * dimension, r * dimension + tiles[r*columns+c][arg3]["vlavo,dole"][1] * dimension)
          ctx.lineTo(c * dimension + tiles[r*columns+c][arg3].vlavo[0] * dimension, r * dimension + tiles[r*columns+c][arg3].vlavo[1] * dimension)
          ctx.lineTo(c * dimension + tiles[r*columns+c][arg3]["vlavo,hore"][0] * dimension, r * dimension + tiles[r*columns+c][arg3]["vlavo,hore"][1] * dimension)
          ctx.lineTo(c * dimension + tiles[r*columns+c][arg3].hore[0] * dimension, r * dimension + tiles[r*columns+c][arg3].hore[1] * dimension)
          ctx.lineTo(c * dimension + tiles[r*columns+c][arg3]["vpravo,hore"][0] * dimension, r * dimension + tiles[r*columns+c][arg3]["vpravo,hore"][1] * dimension)
          ctx.closePath()
          ctx.fill()
          ctx.stroke()
        }
